    ...
    return (function(t) {
        ...
        function(t, e, n) {
            ...
            (e.encodeBase64Packet = function(t, n) {
                ...
                try {
                    ...
                    for (
                        var a = new Uint8Array(t.data), c = new Array(a.length), u = 0; u < a.length; u++
                    )
                        c[u] = a[u];
                    ...
                    void c(t, r, function(t, e) {
                        ...
                        return (
                            e.forEach(function(t) {
                                ...
                                if (e) {
                                    for (
                                        var r = new Uint8Array(t.length), s = 0; s < t.length; s++
                                    )
                                        r[s] = t.charCodeAt(s);
                                    n = r.buffer;
                                }
                                e ? (o[i++] = 0) : (o[i++] = 1);
                                for (
                                    var a = n.byteLength.toString(), s = 0; s < a.length; s++
                                )
                                    o[i++] = parseInt(a[s]);
                                o[i++] = 255;
            ...
            (e.decodePayloadAsBinary = function(t, n, r) {
                ...
                for (var o = t, i = []; o.byteLength > 0;) {
                    for (
                        var s = new Uint8Array(o), a = 0 === s[0], c = "", u = 1; 255 !== s[u]; u++
                    ) {
        ...
        function(t, e) {
            t.exports = function(t, e, n) {
                ...
                for (
                    var o = new Uint8Array(t), i = new Uint8Array(n - e), s = e, a = 0; s < n; s++, a++
                )
                    i[a] = o[s];
                return i.buffer;
            };
